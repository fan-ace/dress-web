...
/**
 * Implementation of LoginPopup for FashionTypeDiagnosisPage
 * This class provides the specific locators for the login popup when it appears on the FashionTypeDiagnosisPage
 */
export class FashionTypeDiagnosisLoginPopup extends BaseLoginPopup {
    // Popup UI elements
    ...
    /**
     * Create a new FashionTypeDiagnosisLoginPopup instance
     * @param page - Playwright Page object
     */
    constructor(page: Page) {
        super(page);

        // Initialize locators specific to FashionTypeDiagnosisPage

        // Popup UI elements - these could be different from other pages
        ...
        this.submitButton = this.page.getByText('メールでログイン');

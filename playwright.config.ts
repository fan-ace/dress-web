...
export default defineConfig({
  ...
  reporter: [
    ...
    ['allure-playwright', {
      ...
      suiteTitle: false
    }], // Allure Report with enhanced configuration
  ],
  ...
  projects: [
    {
      name: 'chromium',
      use: {
        // Use a fixed, large viewport size instead of null
        viewport: { width: 1920, height: 1080 },
        // Only use storageState if auth.json exists
